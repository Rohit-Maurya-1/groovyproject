  ...
  return (
    <div className="h-screen pt-32 w-full flex flex-col md:flex-row items-center justify-between p-6 md:pl-16 bg-[#FBB9BB]">
      <div className="text-center md:text-left">
        ...
        <div className="font-oswald font-semibold uppercase text-xl md:text-3xl lg:text-4xl text-gray-100 mb-4">
      ...
      <img src={anar} alt="Anar Banner" className="h-64 md:h-full mt-8 md:mt-0 object-contain" />
    </div>
  );
};
