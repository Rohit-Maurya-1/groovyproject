  ...
  return (
    <div className="w-full relative flex flex-col md:flex-row justify-center items-center bg-[#CF4758] pb-6">
      <div className="w-full md:w-1/3 p-4 md:pl-16 text-center md:text-left">
        <h1 className="text-4xl md:text-6xl lg:text-8xl uppercase text-white tracking-tighter leading-tight md:leading-[5rem]">
          Fresh from source
        </h1>
      </div>
      <div
      ...
      <img
        src={leaf}
        alt=""
        className="move-img w-12 md:w-20 absolute top-4 md:top-10 right-12 md:right-24"
      />
      <img
        src={leaf2}
        alt=""
        className="move-img1 w-12 md:w-20 absolute top-40 md:top-60 right-24 md:right-96"
      />
      <img
        src={leaf3}
        alt=""
        className="move-img w-12 md:w-20 absolute top-8 md:top-16 left-12 md:left-24"
      />
      <img
        src={leaf}
        alt=""
        className="move-img1 w-12 md:w-20 absolute bottom-24 md:bottom-36 left-12 md:left-24 rotate-90"
      />
    </div>
  );
};
